...
3. React is headless; UI is optional registry or npm package. Wired upload controls take the `useUpload()` return as `upload` — they do not call the hook or accept engine options.
