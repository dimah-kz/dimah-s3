...
Minimal [Hono](https://hono.dev) starter with a Vite + React UI and [dimah-s3](https://s3.dimah.dev): `toHonoHandler` presign routes, `s3Client.Provider`, and an upload button.
...
Same wiring as [Quickstart](https://s3.dimah.dev/docs/quickstart) (Hono tab), [Server setup](https://s3.dimah.dev/docs/server/setup), [Client setup](https://s3.dimah.dev/docs/react/setup), and [UI setup](https://s3.dimah.dev/docs/react/ui).
