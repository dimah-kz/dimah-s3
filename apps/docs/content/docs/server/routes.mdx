...
<TypeTable
  type={{
    upload: {
      ...
      description:
        "Enables upload. Configures fileTypes, maxFileSize, object, acl, method, expiresIn, and hooks.",
    },
    download: {
      type: "boolean | DownloadConfig",
      description:
        "Enables download. Configures expiresIn (default 600s), disposition, mode (presign | proxy), and hooks.",
    },
    delete: {
      type: "boolean | DeleteConfig",
      description:
        "Enables delete. Configures delete guards and cleanup hooks.",
    },
    keyPrefix: {
      type: "string | false",
      description:
        "Route namespace prefix. Defaults to route name. Set false to disable bounding.",
    },
    guard: {
      type: "(ctx) => Promise<void> | void",
      description: "Guard hook running before any operation on this route.",
    },
    client: {
      type: "S3Client",
      description: "Override S3 client for this route.",
    },
    bucket: {
      type: "string",
      description: "Override S3 bucket for this route.",
    },
  }}
/>
