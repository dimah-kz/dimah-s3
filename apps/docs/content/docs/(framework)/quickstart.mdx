...
```npm
npm i @dimah-s3/core @dimah-s3/server @dimah-s3/react @dimah-s3/ui @aws-sdk/client-s3
```
...
Use provider-specific values (AWS S3, R2, MinIO) for these env vars.
...
Examples for other frameworks will be added soon.
