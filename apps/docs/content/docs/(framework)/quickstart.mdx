...
Mount near the app root (provider + toaster):
...
One-time styles and toaster: [Setup](/docs/react/ui/setup). Then add a
component:
...
<Callout type="info">
  ...
  setup](/docs/react/setup), and [Setup](/docs/react/ui/setup).
</Callout>
