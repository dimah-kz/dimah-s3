...
Database plugin guards run **first** to verify scope ownership. Your route and
operation guards run **second** for application-specific authorization. This
follows the standard [plugin hook order](/docs/server/plugins#hook-execution-order).
