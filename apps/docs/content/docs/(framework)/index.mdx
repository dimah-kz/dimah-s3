---
title: Introduction
description: Full-stack S3 toolkit for the React ecosystem — server, client, optional UI and DB.
icon: House
---

dimah-s3 is a full-stack S3 toolkit for the React ecosystem. It ships server
handlers, headless React hooks, optional UI, and an optional database plugin
for object tracking. You pass in your own AWS SDK `S3Client`.
