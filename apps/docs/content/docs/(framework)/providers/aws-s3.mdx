---
title: Amazon S3
description: Bucket CORS required for browser uploads to AWS S3.
---
...
Set up the client once in [Quickstart](/docs/quickstart). The only extra step for browser uploads is bucket CORS.
