...
<Callout type="info">
  For ready-made upload, download, and delete controls, continue with [UI
  setup](/docs/react/ui/setup) — stylesheet, toaster, then components. This page
  stays on the headless client.
</Callout>
