export function HomeBackground() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,var(--color-fd-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-fd-border)_1px,transparent_1px)] mask-[linear-gradient(to_bottom,transparent,black_10%,black_78%,transparent)] bg-size-[56px_56px] opacity-30" />
